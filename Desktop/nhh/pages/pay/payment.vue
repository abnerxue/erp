		...
		<view class="block">
			<view class="content">
				<view class="orderinfo">
					<view class="row">
						<view class="nominal">订单名称:</view><view class="text">{{orderinfo.goods[0].title}}</view>
					</view>
					<view class="row">
						<view class="nominal">订单金额:</view><view class="text">{{orderinfo.totalPrice}}元</view>
					</view>
				</view>
			</view>
		</view>
			...
			<view class="content">
				<view class="pay-list">
					<view class="row" @tap="paytype='alipay'">
						<view class="left">
							<image src="/static/mine/alipay.png"></image>
						</view>
						<view class="center">
							支付宝支付
						</view>
					...
					<view class="row" @tap="paytype='wxpay'">
						<view class="left">
							<image src="/static/mine/wxpay.png"></image>
						</view>
						<view class="center">
							微信支付
						</view>
